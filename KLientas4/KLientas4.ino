     ...
     if (client.available()) {
        ...
        if(c == '>'){
          ...
          for (int i = 0; i < 4; i++){
            ...
            if (dataStr[0] == '0' && dataStr[1] == '0' && dataStr[2] == '0' && dataStr[3] == '2'){rele = !rele; digitalWrite(LBUILTIN, rele);ilgas();}
...
void httpRequest() {
  ...
  if (client.connect(server, 80)) {
    ...
    client.println("Host: www.xxx.lt");
    //client.println("Host: 192.168.1.30");
