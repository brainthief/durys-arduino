...
const unsigned char scrollText[] PROGMEM ={" VšĮ Panevėžio fizinės medicinos ir reabilitacijos centras “pirmuosius žingsnius” žengė prieš 19 metų, kai 1991 m. liepos 1 d. Panevėžio mieste buvo atidaryta nauja miesto poliklinika su fizinės medicinos ir reabilitacijos skyriumi. Prasidėjus reformai sveikatos sistemoje, fizinės medicinos ir reabilitacijos paslaugos buvo priskirtos antrinio lygio asmens sveikatos priežiūros paslaugoms, o poliklinika tapo pirminės asmens sveikatos priežiūros įstaiga. Tuo metu reabilitacijos skyriaus vedėju dirbęs fizinės medicinos ir reabilitacijos gydytojas Jonas Laurinaitis ryžosi vadovauti reorganizacijos metu įkurtai atskirai įstaigai. Taip, akredituotas ir licencijuotas, 2001 metų birželio 4 dieną savo veiklą pradėjo VšĮ Panevėžio fizinės medicinos ir reabilitacijos centras – viena pirmųjų tokio profilio ambulatorinių įstaigų Lietuvoje. "};
